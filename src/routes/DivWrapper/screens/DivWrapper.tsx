...
const touchFeelOptions = [
  ...
  {
    icon: "https://c.animaapp.com/mkve5d5vXaRKB0/img/group-282.png",
    label: "Fragmented",
  },
];
              ...
              <section className="mb-8">
                <Card className="rounded-[20px] border border-[#101014] opacity-30">
                  <CardContent className="p-0">
                    <div className="grid grid-cols-2 divide-x divide-[#101014]">
                ...
                <Card className="bg-[#f7f7f8] rounded-[20px] border-0">
                  <CardContent className="p-6">
                    <div className="flex justify-end gap-2.5">
                      ...
                      >
                        <span className="[font-family:'Inter',Helvetica] font-light italic text-text text-xs leading-8">
                          Recyclable сode 21
                        </span>
                      </Badge>
                      <Badge
                        variant="outline"
                        className="flex items-center gap-2.5 bg-white rounded-[50px] border border-[#b7b7b94c] h-auto px-5 py-[5px]"
                      >
                        <span className="[font-family:'Inter',Helvetica] font-light italic text-text text-xs leading-8">
                          Sustainability rate
                        </span>
                        <img
                          className="w-[70.83px] h-3"
                          alt="Rating"
                          src="https://c.animaapp.com/mkve5d5vXaRKB0/img/group-398.png"
                        />
                      </Badge>
                    </div>
                  </CardContent>
                ...
                <Card className="rounded-[20px] border border-[#101014] opacity-30">
                  <CardContent className="p-6">
                        ...
                        <Card className="bg-[#f7f7f8] rounded-[20px] border-0">
                          <CardContent className="p-6">
                            <div className="grid grid-cols-3 gap-6">
                              {boxTypes.slice(2).map((box, index) => (
                                <div key={index} className="text-center">
                                  <Card className="bg-white rounded-[20px] border border-[#101014] mb-2.5">
                    ...
                    <div className="mt-6 text-center">
                      <p className="[font-family:'Inter',Helvetica] font-medium text-text text-lg tracking-[0] leading-8">
                        DRIP &amp; BREW BAGS
                      </p>
                    </div>
                  </CardContent>
              ...
              <section className="mb-8">
                ...
                <div className="grid grid-cols-2 gap-6">
                  {featuresList.map((feature, index) => (
                    <Card
                      key={index}
                      className="bg-bg-gray rounded-[20px] border-0 opacity-50"
                    >
              ...
              {socialIcons.map((social, index) => (
                <div
                  ...
                  className={`w-10 h-10 rounded-[10px] flex items-center justify-center ${
                    social.active ? "bg-main" : "border border-[#7ba0d0]"
                  }`}
                >
