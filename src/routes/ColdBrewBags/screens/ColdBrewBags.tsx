...
const footerSections = [
  ...
  },
  {
    ...
    links: [
      "Drip Bags",
      { text: "Brew Bags", opacity: true },
      { text: "Cold Brew Bags", opacity: false, href: "/cold-brew-bags" },
      { text: "Capsules", opacity: true },
    ],
  },
  {
    title: "WIKI",
...
export const ColdBrewBags = (): JSX.Element => {
              ...
              <div className="flex-1 bg-[#f7f7f8] rounded-[20px] p-6 relative">
                ...
                <div className="absolute top-1/2 right-4 w-[27px] h-[27px] bg-[#ffffff38] rounded-[60px] border border-white backdrop-blur-sm flex items-center justify-center">
                  <img
                    className="w-[15px] h-[15px]"
                    alt="Click"
                    src="https://c.animaapp.com/mkvdupvcUy2tgs/img/cursor-finger-click-1.svg"
                  />
                </div>
                <img
                  className="absolute top-8 left-16 w-[83px] h-20"
                  alt="Mask"
                  src="https://c.animaapp.com/mkvdupvcUy2tgs/img/mask-group-4.png"
                />
              </div>
              ...
              {socialIcons.map((social, index) => (
                <button
                  ...
                  className={`w-10 h-10 rounded-[10px] flex items-center justify-center transition-colors ${
                    social.isActive ? "bg-main" : "border border-[#7ba0d0] hover:bg-gray-50"
                  }`}
                >
