...
const printOptions = [
  {
    ...
    subtitle: "(from stock)",
    image:
      "https://c.animaapp.com/mko1bcw3ZdsnAC/img/matte-coffee-bag-mockup-01-1.png",
  },
  {
    title: "PARTLY PRINTED",
    subtitle: "(FRONT & BACK)",
    image:
      "https://c.animaapp.com/mko1bcw3ZdsnAC/img/matte-coffee-bag-mockup-02-1.png",
  },
  {
    title: "FULLY PRINTED",
    subtitle: "(front & back + side gussets)",
    image:
      "https://c.animaapp.com/mko1bcw3ZdsnAC/img/matte-coffee-bag-mockup-01-2.png",
  },
];
...
export const FlatBottomBags = (): JSX.Element => {
                      ...
                      <li key={linkIndex}>
                        <a
                          ...
                          className={`[font-family:'Inter',Helvetica] font-normal text-text text-sm leading-6 hover:text-main transition-colors ${
                            section.title === "SERVICES" && linkIndex > 0
                              ? "opacity-50"
                              : ""
                          }`}
                        >
