...
const printOptions = [
    {
        ...
        subtitle: "(from stock)",
        image:
            "https://c.animaapp.com/mko1bcw3ZdsnAC/img/matte-coffee-bag-mockup-01-1.png", // Reusing image, might need specific one
    },
    {
        title: "FULLY PRINTED",
        subtitle: "(front & back & bottom)",
        image:
            "https://c.animaapp.com/mko1bcw3ZdsnAC/img/matte-coffee-bag-mockup-01-2.png", // Reusing image
    },
];
...
const featuresList = [
    {
        ...
        image: "https://c.animaapp.com/mkve5d5vXaRKB0/img/vector-127.svg", // Reusing placeholder
...
const footerSections = [
    ...
    {
        title: "CONTACT US", // Added to match footer visual potentially or just consistent structure
        links: []
    }
];

export const StandupBags = (): JSX.Element => {
        ...
        <div className="min-h-screen bg-white overflow-x-hidden">
            ...
            <main className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-[100px] xl:pl-[414px]">
                <aside className="hidden xl:flex fixed left-[100px] top-[132px] flex-col gap-3 z-40">
                    {/* Inactive Card - Flat Bottom Bags */}
                    <Link to="/products">
                        ...
                        <CardContent className="flex items-center gap-4 p-0 h-full px-6">
                            <div className="w-10 h-10 flex items-center justify-center">
                                <img
                                    ...
                                    src="https://c.animaapp.com/mko1bcw3ZdsnAC/img/vector-2.png" // reused icon
                                />
                            </div>
                    ...
                    <div className="flex flex-col lg:flex-row gap-8 items-start justify-between">
                        <div className="relative flex justify-center lg:justify-start flex-shrink-0">
                            <div className="w-full max-w-[550px] h-[450px] bg-bg-beige rounded-[20px] flex items-center justify-center relative">
                                <img
                                    ...
                                    alt="Standup bag"
                                    src="https://c.animaapp.com/mko1bcw3ZdsnAC/img/matte-coffee-bag-mockup-02-2.png" // Placeholder, should be standup bag image
                                />
                        ...
                        <div className="space-y-6 max-w-[520px]">
                            ...
                            <p className="[font-family:'Inter',Helvetica] font-normal text-text text-lg leading-[22px]">
                                ...
                                <br />
                                <span className="text-[#FBBF24]">⚠</span> {/* Placeholder for icon */}
                            </p>
                ...
                {/* MOQ Section - Recreated clean without opacity-30 on container */}
                ...
                <section className="mb-16">
                    ...
                    {/* MATERIALS */}
                    <Card className="rounded-[20px] border border-[#101014]/30 mb-8"> {/* Using border opacity instead of container opacity */}
                        <CardContent className="p-4 sm:p-6 md:p-8">
                                ...
                                <Card className="bg-[#f7f7f8] rounded-[20px] border-0">
                                    <CardContent className="p-6">
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            {/* Rating removed if not in screenshot, keeping structure flexible */}
                                ...
                                <Card className="bg-[#f7f7f8] rounded-[20px] border-0">
                                    <CardContent className="p-6">
                                        <img
                                            className="w-full h-[132px] object-cover mb-4 rounded-lg"
                                            alt="Barrier series"
                                            src="https://c.animaapp.com/mkve5d5vXaRKB0/img/mask-group-3.png" // Reused placeholder
                                        />
                                        <h4 className="[font-family:'Inter',Helvetica] font-medium text-text text-lg leading-8 mb-2">
                                            BARRIER SERIES
                                        </h4>
                    ...
                    <Card className="rounded-[20px] border border-[#101014]/30 bg-transparent mb-8">
                        <CardContent className="p-4 sm:p-6 md:p-8">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 md:gap-8"> {/* 2x2 grid based on screenshot */}
                                {featuresList.map((feature, index) => (
                                    <Card key={index} className="bg-bg-gray rounded-[20px] bg-opacity-[0.5] border-0"> {/* Replaced opacity-50 with bg-opacity */}
